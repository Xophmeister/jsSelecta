...
/*
  ...
  We need Array.prototype.filter, so provide a shim where it's not
  available, using code adapted from MDN:

    https://developer.mozilla.org/en-US/docs/JavaScript/Reference/Global_Objects/Array/filter
 
  I'm not sure this is really necessary, nowadays. Remove after Windows
  XP's end of life (1st April, 2014), when IE8 will also die :)
